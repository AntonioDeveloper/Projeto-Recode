...
CREATE TABLE IF NOT EXISTS `postagens` (
  ...
  `videoprincipal` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `titulo` varchar(150) NOT NULL,
  `descricao` varchar(400) NOT NULL,
  `imagemcard` varchar(150) NOT NULL,
  `videolibras` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
